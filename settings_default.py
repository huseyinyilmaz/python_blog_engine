...
DATABASES = {
    'default': {
        ...
        'NAME': 'pbe.db',                      # Or path to database file if using sqlite3.
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'unix:/srv/memcached.sock',
    }
}
...
STATICFILES_DIRS = (
    os.path.join(os.path.dirname(__file__), 'mainstatic/'),
...
SECRET_KEY = 'jy3i+r_dvg9y@wn9f&0#8#@gxev(wh*fr7d1=4!8-l=ab2gzz#'
